...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Pong_t, stringdata) + ofs \
...
const QMetaObject Pong::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Pong.data,
      qt_meta_data_Pong,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Pong.stringdata))
